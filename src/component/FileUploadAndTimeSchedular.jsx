...
import { setAttachments, removeAttachment, setScheduleTime } from '../slices/emailSchedularSlice';
...
export default function FileUploadAndTimeSchedular() {
  ...
  const { attachments, scheduleTime } = useSelector(state => state.emailSchedular);
